...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default=EMAIL_HOST_USER or "no-reply@venopai.com")
SUPPORT_EMAIL = config("SUPPORT_EMAIL", default=EMAIL_HOST_USER or "support@venopai.com")
